...
public class DrawOffsetVisitor extends ASTVisitor {
    ...
    private HashMap<AST, Integer> integerOffsets;
    ...
    public DrawOffsetVisitor(int[] nCount, HashMap<AST, Integer> integerOffsets, int maxOffset) {
        this.nCount = nCount;
        this.integerOffsets = integerOffsets;
    ...
    public void draw(String s, AST t) {
        ...
        int x = integerOffsets.get(t) * hstep;
        int y = depth * vstep;
        ...
        for (int i = 1; i <= t.kidCount(); i++) {
            endx = (integerOffsets.get(t.getKid(i)) * hstep) + nodew / 2;
            endy = (depth + 1) * vstep;
    ...
    public Object visitUtf16StringLitTree(AST t) {
        draw("utf16string: " + ((Utf16StringLitTree) t).getSymbol().toString(), t);
        return null;
    }
