...
*/
    ...
    public Object visitUtf16StringLitTree(AST t) { print("utf16string: "+((Utf16StringLitTree)t).getSymbol().toString(),t);  return null; }

    public Object visitTimestampTypeTree(AST t) { print("Timestamp",t);  return null; }
